...
#SBATCH --output=/scratch/Users/hoto7260/nextflow_out/Nascent/e_and_o/ADP_smAECs.%j.out # Standard output
#SBATCH --error=/scratch/Users/hoto7260/nextflow_out/Nascent/e_and_o/ADP_smAECs.%j.err # Standard error log
...
nextflow run ${SRC}/main.nf -profile slurm_grch38 --workdir '/scratch/Users/hoto7260/nextflow_out/Nascent/tmp/' --genome_id 'hg38' --outdir '/scratch/Users/hoto7260/nextflow_out/Nascent/ADP_smAECs_03-4-24/' --email hope.townsend@colorado.edu --fastqs '/Users/hoto7260/sra_test/fastq/ADP_smAEC/*.fastq.gz' --flip --saveTrim --singleEnd --skipRSeQC --skippicard --skippileup 
