...
NXF_DEBUG=1 /scratch/Shares/dowell/dbnascent/pipeline_assets/nextflow run ${SRC_DIR}/main.nf \
 --mmfiltbams "/scratch/Users/hoto7260/nextflow_out/Bidir_Count/CUWA/Sasse2019B2B_30_min/mmfiltbams/*.bam" \
 --cons_file ~/projects/Resp_Env/Comb_UPM_WSP_ADP/mumerge/out/UPM_WSP_ADP_tfit_MUMERGE.bed \
 -work-dir ${work_dir} \
 --outdir /scratch/Users/hoto7260/nextflow_out/Bidir_Count/CUWA/Sasse2019B2B_30_min/ \
 --prefix Sasse2019B2B \
 --date 9.8.25 \
 --geneputcounts "/scratch/Users/hoto7260/nextflow_out/Bidir_Count/CUWA/Sasse2019B2B_30_min/mmfiltbams/put_gene_counts.txt" \
 --count_limit_bids 80 \
